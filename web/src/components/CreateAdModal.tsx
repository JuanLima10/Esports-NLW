...
export function CreateAdModal() {
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md w-[500px] max-w-full shadow-lg shadow-black/25">
                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <SelectDefault name="game">
                            {games
                                .sort((a, b) => (a.title > b.title) ? 1 : -1)
                                .map(game => {
                                    return (
                                        <Select.Item key={game.id} value={game.id} className="flex items-center h-6 pl-3 my-1 pr-6 relative text-white rounded-sm cursor-pointer hover:bg-zinc-500">
                                            <Select.ItemText>{game.title}</Select.ItemText>
                                            <Select.ItemIndicator className="absolute right-2 w-6">
                                                <Check />
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <InputDefault name="name" id="name" placeholder="Como te chamam dentro do game?" />
                    </div>

                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div className="flex flex-col gap-2">
                            <label htmlFor="yearsPlaying">Joga a quantos anos?</label>
                            <InputDefault name="yearsPlaying" id="yearsPlaying" type="number" placeholder="Tudo bem ser 0" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <label htmlFor="discord">Qual o seu discord?</label>
                            <InputDefault name="discord" id="discord" placeholder="ususario#0000" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6 sm:flex-row">
                        <div className="flex flex-col gap-2">
                            ...
                            <ToggleGroup.Root type="multiple" onValueChange={setWeekDays} value={weekDays} className="flex flex-wrap items-center justify-center gap-2 mt-4 sm:grid sm:grid-cols-4 sm:gap-1 sm:mr-9 sm:mt-0">
                        ...
                        <div className="flex flex-col gap-2 flex-1">
                            ...
                            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                                <InputDefault name="hourStart" id="hourStart" type="time" placeholder="De" />
                                <InputDefault name="hourEnd" id="hourEnd" type="time" placeholder="Até" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 flex flex-wrap-reverse justify-center gap-4 sm:justify-end">
